...
df=pd.read_csv('Vizualisation\Dashboard\uber.csv', delimiter=",") 
...
uber_logo = Image.open('Vizualisation\Dashboard\Uber.png')
...
my_pic = Image.open('Vizualisation\Dashboard\CV.jpg')
with st.sidebar:
